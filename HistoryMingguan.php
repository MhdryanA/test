...
if (isset($_SESSION['username'])) {
    ...
    $query = "SELECT * FROM laporanmingguan WHERE username = '$username' ORDER BY id DESC";
$result = $conn->query($query);
 if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td><a href='DetailHistoryM.php?id=" . $row['id'] . "'>More</a></td>"; // Ganti 'detail_data.php' dengan nama halaman yang akan menampilkan detail data, 'username' adalah kolom unik di tabel
            echo "</tr>";
        }
        echo "</table>";
    } else {
        echo "Tidak ada data laporan Mingguan";
    }
