...
if (isset($_SESSION['username'])) {
    ...
    $query = "SELECT * FROM laporanharian WHERE username = '$username'";
   ...
   if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td><a href='DetailHistoryH.php?id=" . $row['id'] . "'>More</a></td>"; // Ganti 'detail_data.php' dengan nama halaman yang akan menampilkan detail data, 'username' adalah kolom unik di tabel
            echo "</tr>";
        }
        echo "</table>";
    } else {
        echo "Tidak ada data laporan harian";
    }
